...
GEOM(2).age=3.154e13*[8 4 0.01]./t0;%[10 9 8 7 6 0.1];%[10.5 10.4 10.3 10.2 10.1 0.1];  % age of each block [Ma]*convert
GEOM(2).step=2*3.1e-5*3300*1280/2300*sqrt(3*abs(GEOM(2).age-max(GEOM(2).age))/(3300*1000)/pi)/H0;
...
GEOM(2).weakTime=10*3.13e13/t0;        %ma
% MATERIAL PROPERTIES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
PARAMS.gy=StNum;%9.8; % gravity along y
